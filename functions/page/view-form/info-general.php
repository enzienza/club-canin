...
// TITRE LOCATION --------------------------------------------------------------
function display_section_location_titre(){}

function field_location_titre(){
    $info_adresse = esc_attr(get_option('location_titre'));
    ?>
        <input class="widefat" type="text" id="location_titre" name="location_titre" value="<?php echo(get_option('location_titre')); ?>">
    <?php
} // END --> field_location_titre
